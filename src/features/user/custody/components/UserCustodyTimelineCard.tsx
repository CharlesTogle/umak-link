...
import type { StudentCustodyHistoryEntry } from '@/shared/lib/api-types'
import type { UserCustodyTimelineCardProps } from '@/features/user/custody/types/user-custody'
...
function UserCustodyTimelineEntry ({
  entry
}: {
...
export default function UserCustodyTimelineCard ({
  history,
  isLoading = false
}: UserCustodyTimelineCardProps) {
  if (isLoading) {
    return (
